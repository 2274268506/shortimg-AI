...
type User struct {
	...
	Password  string         `gorm:"type:varchar(255);not null" json:"-"`                 // 不返回密码到前端
	Role      string         `gorm:"type:varchar(20);default:user;index" json:"role"`     // user, admin
	...
	LoginIP   string         `gorm:"type:varchar(50)" json:"loginIP,omitempty"`           // 最后登录IP
